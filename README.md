...
This is a project about the different aspects of Digital Literacy. This project teaches us how to use different digital tools to make our work easier. It also tells us about the different platforms in which one can create a sound digital portfolio.
...
This module taught us about the different types of digital tools available that can make it way easier for the students to make presentaions. It also teaches on how to use these different types of tools, from setting up accounts to how the shortcuts work.
...
This module taught us the importance of creating a digital portfolio and the different digital tools that a student can use to create them. This module taught us about the specific advantages of different platforms and how one can ealily set up accounts in these platforms.
...
This module taught us about the benifits of different programming platforms and platforms that allow collaborative learning. This module taught us how one can use these platforms to increase our knowlege and how eaily one can set up accounts in these platforms.
...
This module taught us the importance of way of speech in a professional environment and why social media etiquette should be practiced. It taught us how a person should behave in a work place and how a formal mail should be written as to not look like disrespectful.
...
This module taught us about what cyber crime actually is and it's types that take place in today's world. It also taught us about the ways followed by the scammers in order to scam the innocent. It aslo taught us about the how one can prevent such things from happening.
...
In conclusion, this project helped me gain a lot of useful knowledge that I will surely use in the next four years and maybe more. This has proved to be a very good learning experience for me.
